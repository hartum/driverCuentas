...
export const initializeDatabase = async () => {
  ...
  if (value) {
    ...
    alasql('CREATE TABLE IF NOT EXISTS shifts (id INT PRIMARY KEY AUTO_INCREMENT, startDateTime DATETIME, endDateTime DATETIME, initialKm FLOAT, finalKm FLOAT, totalKm FLOAT, modeKM STRING, gasoline FLOAT, totalShift FLOAT, modeTotalShift STRING)');
